...
class HtmlParser:
    ...
    def find_linked_css_urls(self) -> list:
        return get_linked_css_url(self.html)

    def find_linked_css_count(self) -> int:
        return len(get_linked_css_url(self.html))

    def find_linked_scripts_url(self) -> list:
        return get_linked_scripts_url(self.html)

    def find_linked_scripts_count(self) -> int:
        return len(get_linked_scripts_url(self.html))
